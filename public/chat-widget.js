...
innerHTML: `<svg class="chat-widget-button-icon" fill="currentColor" viewBox="0 0 24 24"><path d="M20 2H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h4v3c0 .6.4 1 1 1 .2 0 .5-.1.7-.3L14.6 18H20c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2z"/></svg>`
...
const closeBtn = this.createElement('button', { className: 'chat-widget-close-btn', innerHTML: '×', ariaLabel: 'Close Chat' });
...
const sendButton = this.createElement('button', { ariaLabel: 'Send Message', innerHTML: `<svg class="chat-widget-send-icon" fill="currentColor" viewBox="0 0 24 24"><path d="M2.01 21L23 12 2.01 3 2 10l15 2-15 2z"/></svg>` });
...
console.log('addMessageToUI called with:', sender, typeof text);
...
console.log('Creating carousel with products:', item.products.length);
